...
var phase = 1;
function preload(){
 //snake_image = loadImage("snake.png");
 //snake2_image = loadImage("snake.png");
 //spider_image = loadImage("spider.png");
 //spider2_image = loadImage("spider.png");
 //spider3_image = loadImage("spider.png");
 //stalker_image = loadImage("ghost-standing.png");
}
function setup(){
  createCanvas(600,600)
  Pc = createSprite(330,570,20,20); 
  snake = createSprite(150,510,20,20);
  snake.velocityY = 5;
  //snake.addImage(snake_image);
  snake2 = createSprite(510,510,20,20);
  snake2.velocityY = 5;
  //snake2.addImage(snake2_image);
  spider = createSprite(120,210,20,20);
  spider.velocityX = 5;
  //spider.addImage(spider_image);
  spider2 = createSprite(450,360,20,20);
  spider2.velocityY = 5;
  //spider2.addImage(spider2_image);
  spider3 = createSprite(420,150,20,20);
  spider3.velocityX = 5;
  //spider3.addImage(spider3_image);
  stalker = createSprite(270,30,20,20)
  stalker.velocityX = -4;
  laser = createSprite(217.5,60,65,5)
  laser.shapeColor = "red";
  laser2 = createSprite(420,35,5,60)
  ...
  wall34 = createSprite(235,180,10,120);
